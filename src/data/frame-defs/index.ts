...
import { whydontwe } from './whydontwe'
import { whattimedoyou } from './whattimedoyou'
import { gladto } from './gladto'
import { sorryto } from './sorryto'
import { notsureabout } from './notsureabout'
import { haveyouever } from './haveyouever'

/** 元サイトの 10 型に追加した型（1 型 1 ファイル）。ここに並べた順にホームへ表示される */
export const EXTRA_FRAME_DEFS: FrameDef[] = [im, its, areyou, doyoulike, doyouhave, whereis, cani, couldyou, letme, dont, needto, idlike, tryingto, forgotto, usedto, ilike, howabout, thankyoufor, isit, thatsounds, itlooks, whydontwe, whattimedoyou, gladto, sorryto, notsureabout, haveyouever]
