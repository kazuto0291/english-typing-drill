...
export const EXTRA_FRAME_DEFS: FrameDef[] = [im, its, areyou, doyoulike, doyouhave, whereis, cani, couldyou, letme, dont, needto, idlike, tryingto, forgotto, usedto, ilike]
